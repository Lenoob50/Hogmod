...
public class ProcedureBroomRightClickedOnEntity extends ElementsHogmodMod.ModElement {
	public ProcedureBroomRightClickedOnEntity(ElementsHogmodMod instance) {
		super(instance, 9);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure BroomRightClickedOnEntity!");
			return;
		}
