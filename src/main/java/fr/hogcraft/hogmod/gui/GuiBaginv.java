...
public class GuiBaginv extends ElementsHogmodMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiBaginv(ElementsHogmodMod instance) {
		super(instance, 24);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("hogmod:textures/baginv.png");
		@Override
