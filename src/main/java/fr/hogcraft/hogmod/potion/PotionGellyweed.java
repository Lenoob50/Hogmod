...
package fr.hogcraft.hogmod.potion;
...
public class PotionGellyweed extends ElementsHogmodMod.ModElement {
	@GameRegistry.ObjectHolder("hogmod:gellyweed")
	public static final Potion potion = null;
	@GameRegistry.ObjectHolder("hogmod:gellyweed")
	public static final PotionType potionType = null;
	public PotionGellyweed(ElementsHogmodMod instance) {
		super(instance, 14);
	}
	...
	public static class PotionCustom extends Potion {
		...
		public PotionCustom() {
			super(false, -16737946);
			setRegistryName("gellyweed");
			setPotionName("effect.gellyweed");
			potionIcon = new ResourceLocation("hogmod:textures/mob_effect/gellyweed.png");
		}
