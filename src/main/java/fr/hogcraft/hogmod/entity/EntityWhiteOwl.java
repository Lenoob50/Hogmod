...
public class EntityWhiteOwl extends ElementsHogmodMod.ModElement {
	public static final int ENTITYID = 11;
	public static final int ENTITYID_RANGED = 12;
	public EntityWhiteOwl(ElementsHogmodMod instance) {
		super(instance, 63);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("hogmod", "white_owl"), ENTITYID)
				.name("white_owl").tracker(64, 3, true).egg(-3381760, -16764109).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelwowl(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("hogmod:textures/r25f3fd831e9c712448cdf39c119ef8ab.jpg.png");
				}
			};
		});
	}
