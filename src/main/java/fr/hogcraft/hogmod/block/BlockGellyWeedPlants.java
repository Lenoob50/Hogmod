...
import fr.hogcraft.hogmod.creativetab.TabHogcraftPlants;
import fr.hogcraft.hogmod.ElementsHogmodMod;

@ElementsHogmodMod.ModElement.Tag
public class BlockGellyWeedPlants extends ElementsHogmodMod.ModElement {
	@GameRegistry.ObjectHolder("hogmod:gelly_weed_plants")
	public static final Block block = null;
	public BlockGellyWeedPlants(ElementsHogmodMod instance) {
		super(instance, 17);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("hogmod:gelly_weed_plants", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setCreativeTab(TabHogcraftPlants.tab);
			setHardness(0F);
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("gelly_weed_plants");
			setRegistryName("gelly_weed_plants");
		}
