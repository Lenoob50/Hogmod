...
public class ItemWandBox extends ElementsHogmodMod.ModElement {
	@GameRegistry.ObjectHolder("hogmod:wand_box")
	public static final Item block = null;
	public ItemWandBox(ElementsHogmodMod instance) {
		super(instance, 67);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("hogmod:wand_box", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("wand_box");
			setRegistryName("wand_box");
