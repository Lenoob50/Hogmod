...
public class ItemBeer extends ElementsHogmodMod.ModElement {
	@GameRegistry.ObjectHolder("hogmod:beer")
	public static final Item block = null;
	public ItemBeer(ElementsHogmodMod instance) {
		super(instance, 42);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("hogmod:beer", "inventory"));
	}
