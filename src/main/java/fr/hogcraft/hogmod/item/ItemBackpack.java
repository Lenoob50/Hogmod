...
import fr.hogcraft.hogmod.procedure.ProcedureBackpackRightClickedInAir;
...
public class ItemBackpack extends ElementsHogmodMod.ModElement {
	@GameRegistry.ObjectHolder("hogmod:backpack")
	public static final Item block = null;
	public ItemBackpack(ElementsHogmodMod instance) {
		super(instance, 24);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("hogmod:backpack", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureBackpackRightClickedInAir.executeProcedure($_dependencies);
			}
			return ar;
		}
